    ...
    <>
      ...
      <main>
        <section className='title-bg-app'>
          <h1 className='shadow-text text-[#f5f5f5] relative top-[280px] lg:top-60 left-4 lg:left-10 mt-28 font-extrabold uppercase text-5xl md:text-6xl lg:text-8xl'>nuestra app</h1>
        </section>
        <SubNav />

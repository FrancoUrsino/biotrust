    ...
    <>
      ...
      <main className=''>
        <section className='title-bg-service'>
          <h1 className='shadow-text text-[#f5f5f5] relative top-[200px] md:top-[190px] 2xl:top-64 left-4 lg:left-10 mt-28 font-extrabold uppercase text-3xl md:text-4xl lg:text-6xl'>servicio técnico</h1>
        </section>
          <SubNav />

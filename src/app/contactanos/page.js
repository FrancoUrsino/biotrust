      ...
      <main className='bg-[#f5f5f5]'>
        <section className='grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 justify-center items-center w-11/12 mx-auto pb-28'>
          <div className='mx-auto w-11/12'>
            <h2 className='text-[#002d4e] font-bold text-2xl lg:text-4xl uppercase pt-10 lg:pt-0 mt-20 lg:mt-48 mb-4'>contáctanos</h2>
            ...
            <p className='py-2 lg:pt-4 lg:pb-6 text-lg lg:text-2xl font-bold'>Tel/Fax: <a href="" target="_blank" className='font-normal hover:text-[#27b2c4]' rel="noopener noreferrer">5273 8995</a></p>

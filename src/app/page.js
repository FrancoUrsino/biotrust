...
import './globals.scss'
import logo22 from '../../public/img/logo22.png'
  ...
  return (
    <div className="hero-bg">
      ...
      <main className="hero w-full mb-56 lg:mb-28">
        <section className="grid md:grid-cols-3 md:grid-rows-1 relative justify-center justify-items-center top-[250px] md:top-[500px] lg:top-[230px] w-10/12 xl:w-9/12 mx-auto md:rounded-bl-3xl md:rounded-br-3xl md:rounded-tl-3xl md:rounded-tr-3xl md:shadow-2xl md:shadow-black">
          {/* CERTIFICADOS */}

          <article className='w-full h-48 md:h-64 lg:h-[380px] xl:h-[450px] object-cover flex flex-col items-center justify-center rounded-t-3xl md:rounded-tr-none md:rounded-l-3xl  bg-[#002D4EA1] group transition-all ease-in duration-500'>
          ...
          {/* SERVICIO TECNICO */}
          <article className='w-full h-48 md:h-64 lg:h-[380px] xl:h-[450px] object-cover flex flex-col items-center justify-center bg-[#118CDF99] group transition-all ease-in duration-500'>
          ...
          <article className='w-full h-48 md:h-64 lg:h-[380px] xl:h-[450px] object-cover flex flex-col items-center justify-center rounded-b-3xl md:rounded-b-none md:rounded-r-3xl bg-[#27B2C4A8] group transition-all ease-in duration-500'>
        ...
        <div className='flex flex-col absolute right-10 top-28' >
          <Image src={logo22} width={100} alt='logo itaes' />
          <p className='flex justify-end font-extrabold text-[#ACD8FF] text-md'>NOS AVALA</p>
        </div>
        <h1 className="mx-auto text-xl w-10/12 md:text-3xl md:w-11/12 xl:text-4xl lg:w-full text-center relative top-[280px] md:top-[550px] lg:top-[300px] 2xl:top-[260px] text-[#f1f1f1] uppercase font-bold">LA MÁS AVANZADA TECNOLOGÍA EN EQUIPAMIENTO MÉDICO</h1>
      </main>
      <Footer/>
    </div>
  );

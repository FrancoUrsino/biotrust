...
export default function Home() {
  return (
    ...
    {/* h-1/2 md:h-3/5 lg:h-5/6 */}
      ...
      <section className="grid md:grid-cols-3 md:grid-rows-1 relative justify-center justify-items-center top-[250px] md:top-[500px] lg:top-[300px] w-10/12 xl:w-9/12 mx-auto">
          {/* CERTIFICADOS */}
          ...
          <article className='w-full h-48 md:h-64 lg:h-[380px] xl:h-[500px] object-cover flex flex-col items-center justify-center  bg-[#118CDF]'>
            <Link href='/servicio-tecnico' className='flex flex-col justify-center items-center'>
          ...
          <article className='w-full h-48 md:h-64 lg:h-[380px] xl:h-[500px] object-cover flex flex-col items-center justify-center rounded-b-3xl md:rounded-b-none md:rounded-r-3xl  bg-[#27B2C4]'>
            ...
            <Image src={kitIcon} width={100} alt='icono de equipamientos' className='mt-4 -translate-y-4 lg:w-56' />

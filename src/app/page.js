  ...
  return (
    <>
      ...
      <main className="hero w-full mb-56 lg:mb-28">
        <section className="grid md:grid-cols-3 md:grid-rows-1 relative justify-center justify-items-center top-[250px] md:top-[500px] lg:top-[230px] w-10/12 xl:w-9/12 mx-auto md:rounded-bl-3xl md:rounded-br-3xl md:rounded-tl-3xl md:rounded-tr-3xl md:shadow-2xl md:shadow-black">
          ...
          <article className='w-full h-48 md:h-64 lg:h-[380px] xl:h-[450px] object-cover flex flex-col items-center justify-center bg-[#118CDF] group transition-all ease-in duration-500'>
            <Link href='/servicio-tecnico' className='flex flex-col justify-center items-center group-hover:translate-y-8 group-hover:scale-125 duration-500'>
              ...
              <p className="py-1 mt-0 text-sm lg:text-3xl text-white text-center uppercase lg:group-hover:text-2xl font-bold lg:translate-y-2">servico técnico</p>
        ...
        <h1 className="mx-auto text-xl w-10/12 md:text-3xl md:w-11/12 xl:text-4xl lg:w-full text-center relative top-[280px] md:top-[550px] lg:top-[300px] 2xl:top-[260px] text-[#002D4E] uppercase font-bold">pioneros y líderes EN REPARACIÓN Y MANTENIMIENTO DE EQUIPAMIENTO MÉDICO</h1>
      </main>
      <Footer/>
    </>
  );

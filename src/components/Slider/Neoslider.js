...
import { ServiceDataNeo } from "../Slider/constants/constant";
        ...
        {ServiceDataNeo.map((item) => (
          <SwiperSlide key={item.title}>
            <div className="flex flex-col gap-6 mb-20 group relative shadow-lg rounded-xl px-6 py-8 h-[250px] w-[215px] lg:h-[400px] lg:w-[350px] overflow-hidden cursor-pointer">
              ...
              />
              <a href={`/equipamiento/${item.page}`} className="absolute inset-0 bg-black opacity-20 group-hover:opacity-30" target="_blank"/>
